...
Welcome to `ds_project` contributor's guide.
...
If you experience bugs or general issues with `ds_project`, please have a look
...
You can help improve `ds_project` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ds_project` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ds_project`'s files. While this mechanism can
...
```
conda create -n ds_project python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ds_project.git
   cd ds_project
   ```
...
5. Install [pre-commit]:
   ...
   `ds_project` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ds_project
[issue tracker]: https://github.com/<USERNAME>/ds_project/issues
